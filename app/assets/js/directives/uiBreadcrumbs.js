define(['appModule'], function (module) {
    ...
    module.registerDirective('uiBreadcrumbs', ['$interpolate', '$state', function($interpolate, $state) {


        /**
         * Displays state breadcrumbs
         */
        return {
            restrict: 'E',
            templateUrl: 'assets/js/directives/uiBreadcrumbsView.html',
            scope: {
                displaynameProperty: '@',
